...
window.onload = () => {
    ...
    engine.world.addComponents(new WorldBackground());
...
function createGameButton() {
    ...
    button.addComponents(new Rect(null, 255), new Text("Create Game", 255, 16), new Button(() => {
...
function createPlayer() {
    ...
    cube.addComponents(new NetEntity(), new SimpleMoverPhysics(decel), new Rect(255), new CubeKeybinds());
